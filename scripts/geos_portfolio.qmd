...
partner_cdrz_all_data %>% filter(geos == 1) %>% group_by(nri_id) %>% select(nri_id, state, county, nickname_geos, geos_community_cluster)%>% 
 ...
 a <-  partner_cdrz_all_data %>% 
  st_drop_geometry() %>%
  filter(geos == 1) %>%
  distinct(geos_community_cluster) 
```
...
geos_tract_portfolio <- function(x) {
  cdrzs_tracts_places_clean %>% 
    ...
    select(c(tract_fips, place_name, county, nickname_geos, geos_community_cluster, state, total_pop, median_hh_income, 
             ...
             sovi_score, sovi_ratng, resl_score, resl_ratng, urban_designation, description)) %>%
...
geos_tract_portfolio("Bay Group")
```
...
geos_tract_portfolio("City of Melbourne")
```
...
geos_tract_portfolio("Deerfield Beach")
```
...
geos_tract_portfolio("Pompano Beach")
```
...
geos_tract_portfolio("Ft Lauderdale")
```

# 6. Oakland & Nth Andrews Parks

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Oakland & Nth Andrews Parks")
```
...
geos_tract_portfolio("Dania Beach")
```

# 8. Charlotte County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Charlotte County Group")
```
...
geos_tract_portfolio("Collier Group")
```

# 10. DeSoto County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("DeSoto County Group")
```

# 11. Hendry Group County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Hendry Group")
```

# 12. Hillsborough County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Hillsborough County Group")
```

# 13. Indian River/ Fellsmere

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Indian River/ Fellsmere")
```
...
geos_tract_portfolio("City of Stuart")
```
...
geos_tract_portfolio("Doral Group")
```

# 16. Homestead & Everglades

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Homestead & Everglades")
```
...
geos_tract_portfolio("Palm Beach Group")
```
...
geos_tract_portfolio("Clearwater City")
```
...
geos_tract_portfolio("St. Lucie Group")
```
...
geos_tract_portfolio("Washington Group")
```

# 21. Bulloch County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Bulloch County Group")
```
...
geos_tract_portfolio("Chatham Group")
```
...
geos_tract_portfolio("Liberty Group")
```

# 24. McIntosh County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("McIntosh County Group")
```

# 25. Seminole County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Seminole County Group")
```

# 26. Wayne County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Wayne County Group")
```
...
geos_tract_portfolio("Beaufort Group")
```

# 28. Carteret County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Carteret County Group")
```
...
geos_tract_portfolio("Craven Group")
```
...
geos_tract_portfolio("Dare Group")
```
...
geos_tract_portfolio("Hyde Group")
```

# 32. New Hanover County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("New Hanover County Group")
```

# 33. Onslow County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Onslow County Group")
```

# 34. Sampson County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Sampson County Group")
```

# 35. Tyrrell County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Tyrrell County Group")
```

# 36. Washington County Group

```{r}
#| include: true
#| echo: false

geos_tract_portfolio("Washington County Group")
```
...
geos_tract_portfolio("Goose Creek")
```
...
geos_tract_portfolio("Charleston Group")
```
...
geos_tract_portfolio("Dorchester Group")
```
...
geos_tract_portfolio("Myrtle Beach")
```
